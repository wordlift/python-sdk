...
- [x] 2026-02-20 Preserve `account.key` in `kg_build` postprocessor runtime payload/context, keep API base URL sourced from `settings.api_url` (with default fallback), and redact keys from debug payload artifacts.
